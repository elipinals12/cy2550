...
void print_help()
{
    ...
    printf("Generate a secure, memorable password using the XKCD method\n\n");

    printf("optional arguments:");
    printf("    -h, --help            show this help message and exit\n");
    printf("    -w WORDS, --words WORDS\n");
    printf("                          include WORDS words in the password (default=4)\n");
    printf("    -c CAPS, --caps CAPS  capitalize the first letter of CAPS random words\n");
    printf("                          (default=0)\n");
    printf("    -n NUMBERS, --numbers NUMBERS\n");
    printf("                          insert NUMBERS random numbers in the password\n");
    printf("                          (default=0)\n");
